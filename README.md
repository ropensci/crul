...
* `mock()` - Turn on mocking, via `webmockr`
...
#> [231] 35 2e 39 39 38 31 22 0a 20 20 7d 2c 20 0a 20 20 22 6f 72 69 67 69 6e
#> [254] 22 3a 20 22 37 31 2e 36 33 2e 32 32 33 2e 31 31 33 22 2c 20 0a 20 20
#> [277] 22 75 72 6c 22 3a 20 22 68 74 74 70 73 3a 2f 2f 68 74 74 70 62 69 6e
#> [300] 2e 6f 72 67 2f 67 65 74 22 0a 7d 0a
```
...
res$request_headers
#> $`User-Agent`
#> [1] "libcurl/7.51.0 r-curl/2.6 crul/0.3.5.9981"
#> 
#> $`Accept-Encoding`
#> [1] "gzip, deflate"
#> 
...
#> 
#> $date
#> [1] "Sun, 21 May 2017 23:16:20 GMT"
#> 
#> $`content-type`
#> [1] "application/json"
#> 
...
#> [1] "{\n  \"args\": {}, \n  \"headers\": {\n    \"A\": \"hello world\", \n    \"Accept\": \"*/*\", \n    \"Accept-Encoding\": \"gzip, deflate\", \n    \"Connection\": \"close\", \n    \"Host\": \"httpbin.org\", \n    \"User-Agent\": \"libcurl/7.51.0 r-curl/2.6 crul/0.3.5.9981\"\n  }, \n  \"origin\": \"71.63.223.113\", \n  \"url\": \"https://httpbin.org/get\"\n}\n"
