...
#> [254] 30 20 72 2d 63 75 72 6c 2f 33 2e 31 20 63 72 75 6c 2f 30 2e 34 2e 32
#> [277] 2e 39 32 31 31 22 0a 20 20 7d 2c 20 0a 20 20 22 6f 72 69 67 69 6e 22
...
res$request_headers
#> $`User-Agent`
#> [1] "libcurl/7.54.0 r-curl/3.1 crul/0.4.2.9211"
#> 
#> $`Accept-Encoding`
#> [1] "gzip, deflate"
#> 
...
#> 
#> $date
#> [1] "Fri, 19 Jan 2018 05:50:37 GMT"
#> 
#> $`content-type`
#> [1] "application/json"
#> 
...
#> [1] "{\n  \"args\": {}, \n  \"headers\": {\n    \"A\": \"hello world\", \n    \"Accept\": \"application/json, text/xml, application/xml, */*\", \n    \"Accept-Encoding\": \"gzip, deflate\", \n    \"Connection\": \"close\", \n    \"Host\": \"httpbin.org\", \n    \"User-Agent\": \"libcurl/7.54.0 r-curl/3.1 crul/0.4.2.9211\"\n  }, \n  \"origin\": \"24.21.229.59\", \n  \"url\": \"https://httpbin.org/get\"\n}\n"
