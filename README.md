...
#> [208] 2e 30 20 72 2d 63 75 72 6c 2f 32 2e 34 20 63 72 75 6c 2f 30 2e 33 2e
#> [231] 34 22 0a 20 20 7d 2c 20 0a 20 20 22 6f 72 69 67 69 6e 22 3a 20 22 34
#> [254] 36 2e 31 38 39 2e 36 37 2e 33 31 22 2c 20 0a 20 20 22 75 72 6c 22 3a
#> [277] 20 22 68 74 74 70 73 3a 2f 2f 68 74 74 70 62 69 6e 2e 6f 72 67 2f 67
#> [300] 65 74 22 0a 7d 0a
```
...
res$request_headers
#> $useragent
#> [1] "libcurl/7.51.0 r-curl/2.4 crul/0.3.4"
#> 
#> $a
#> [1] "hello world"
```
...
#> 
#> $date
#> [1] "Fri, 31 Mar 2017 18:04:07 GMT"
#> 
#> $`content-type`
#> [1] "application/json"
#> 
...
#> [1] "{\n  \"args\": {}, \n  \"headers\": {\n    \"A\": \"hello world\", \n    \"Accept\": \"*/*\", \n    \"Accept-Encoding\": \"gzip, deflate\", \n    \"Connection\": \"close\", \n    \"Host\": \"httpbin.org\", \n    \"User-Agent\": \"libcurl/7.51.0 r-curl/2.4 crul/0.3.4\"\n  }, \n  \"origin\": \"46.189.67.31\", \n  \"url\": \"https://httpbin.org/get\"\n}\n"
