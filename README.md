...
#> [231] 35 2e 39 33 31 38 22 0a 20 20 7d 2c 20 0a 20 20 22 6f 72 69 67 69 6e
#> [254] 22 3a 20 22 31 33 36 2e 31 35 32 2e 32 30 38 2e 32 31 33 22 2c 20 0a
#> [277] 20 20 22 75 72 6c 22 3a 20 22 68 74 74 70 73 3a 2f 2f 68 74 74 70 62
#> [300] 69 6e 2e 6f 72 67 2f 67 65 74 22 0a 7d 0a
```
...
res$request_headers
#> $`User-Agent`
#> [1] "libcurl/7.51.0 r-curl/2.6 crul/0.3.5.9318"
#> 
#> $`Accept-Encoding`
#> [1] "gzip, deflate"
#> 
...
#> 
#> $date
#> [1] "Sat, 20 May 2017 15:46:15 GMT"
#> 
#> $`content-type`
#> [1] "application/json"
#> 
